...
object NetworkModule {
    ...
    private val subwayTimekeyValue = "SEOUL_OPENAPI_KEY_REDACTED"
    ...
    fun makeHttpUrl_subwayTime(station_code:String,week_tag:String,inout_tag:String): HttpUrl {
        ...
        //http://openapi.seoul.go.kr:8088/SEOUL_OPENAPI_KEY_REDACTED/Json/SearchSTNTimeTableByIDService/1/5/0151/1/1/
